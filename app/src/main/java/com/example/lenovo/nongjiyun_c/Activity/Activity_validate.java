...
public class Activity_validate extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
            ...
            public void onClick(View view) {
                if (et_phone_validate_code.length() == 6) {
                    validateCode(et_phone_validate_phonenum.getText().toString(),
                            et_phone_validate_code.getText().toString(), Activity_validate.this);

                } else {
                    ToastMessage.initToastMessage("请输入正确的验证码", Activity_validate.this);
                }
            }
        });
    }
        ...
        BmobSMS.verifySmsCode(context, phonenum, code, new VerifySMSCodeListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    if (str.equals("注册")) {
                        i = new Intent(Activity_validate.this, Activity_reist.class);
                        i.putExtra("phonenum", phonenum);
                        startActivity(i);
                    } else {
                        i = new Intent(Activity_validate.this, Activity_resetpassword.class);
                        i.putExtra("phonenum", phonenum);
                        startActivity(i);
                    }
    ...
    private void requestReadPhonePermission() {
        if (ContextCompat.checkSelfPermission(Activity_validate.this, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Activity_validate.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        } else {
            getMessage();
        }
    }
        ...
        btn_phone_validate_getCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (et_phone_validate_phonenum.length() == 0) {
                    ToastMessage.initToastMessage("请输入手机号", Activity_validate.this);
                } else if (et_phone_validate_phonenum.length() < 11 && et_phone_validate_phonenum.length() > 0) {
                    ToastMessage.initToastMessage("请输入正确手机格式", Activity_validate.this);
                } else {
        ...
        BmobSMS.requestSMSCode(this, phonenum, "农技耘", new RequestSMSCodeListener() {
            ...
            public void done(Integer integer, BmobException e) {
                if (e == null) {//验证码发送成功
                    ...
                    ToastMessage.initToastMessage("信息已发送，请注意查收", Activity_validate.this);
        ...
        switch (requestCode) {
            case 1:
                if ((grantResults.length > 0) && (grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    ToastMessage
                            .initToastMessage("你没启动权限", Activity_validate.this);
                }
                break;

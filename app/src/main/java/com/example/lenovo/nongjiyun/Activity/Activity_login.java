    ...
    private void reister() {
        btn_login_reister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i =new Intent(Activity_login.this,Activity_validate.class);
                i.putExtra("tag","注册");
                startActivity(i);
            }
        });
                ...
                if (et_login_phone.length() != 0) {
                    if (et_login_password.length() != 0) {
                        if (et_login_password.length() < 6 | et_login_password.length() > 20) {
                            ToastMessage.initToastMessage("请输入6~20位密码",Activity_login.this);
                        } else {

                        }
                    } else {
                        ToastMessage.initToastMessage("请填写密码",Activity_login.this);
                    }
                } else {
                    ToastMessage.initToastMessage("请填写手机号",Activity_login.this);
                }
